...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Habitifyme— AI gym coach for budget gym goers" },
      ...
      { property: "og:title", content: "Habitifyme— AI gym coach for budget gym goers" },
      { name: "twitter:title", content: "Habitifyme— AI gym coach for budget gym goers" },
